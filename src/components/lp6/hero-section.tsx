      ...
      {lines.map((line) => (
        <motion.div
          ...
          style={{
            ...
            right: "-100%",
            backgroundImage:
              "linear-gradient(to right, transparent, transparent 50%, rgba(255,255,255,0.7) 50%, rgba(255,255,255,0.7))",
      ...
      {lines.map((line) => (
        <motion.div
          ...
          style={{
            ...
            bottom: "-100%",
            backgroundImage:
              "linear-gradient(to bottom, transparent, transparent 50%, rgba(255,255,255,0.7) 50%, rgba(255,255,255,0.7))",
        ...
        <div className="relative">
          ...
          <div className="container mx-auto px-4 pt-20 pb-32 text-center">
            ...
            >
              ...
              Nova atualização: v1.10 Beta disponível
            </motion.div>
            ...
            >
              Fornecemos às empresas todas as ferramentas necessárias para
              automatizar a extração de dados de documentos e acelerar seu
              crescimento
            </motion.p>
            ...
            >
              <Button
                ...
                onClick={() => {
                  window.open(
                    "https://app.scanify.com.br/sign-up?plan=test",
                    "_blank"
                  );
                }}
              >
