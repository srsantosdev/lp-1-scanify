      ...
      {lines.map((line) => (
        <motion.div
          ...
          style={{
            ...
            left: '-100%',
            right: '-100%',
            backgroundImage: 'linear-gradient(to right, transparent, transparent 50%, white 50%, white)',
      ...
      {lines.map((line) => (
        <motion.div
          ...
          style={{
            ...
            top: '-100%',
            bottom: '-100%',
            backgroundImage: 'linear-gradient(to bottom, transparent, transparent 50%, white 50%, white)',
...
export default function HeroSection() {
  return (
    <div className="min-h-screen bg-[#050407] relative overflow-hidden bg-opacity-95">
      <AnimatedBackground />
